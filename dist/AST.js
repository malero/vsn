...
var Node = /** @class */ (function () {
    ...
    Node.prototype.prepare = function (scope, dom) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        node = _a[_i];
                        return [4 /*yield*/, node.prepare(scope, dom)];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
...
var BlockNode = /** @class */ (function (_super) {
    ...
    BlockNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var returnValue, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.statements[i].evaluate(scope, dom)];
                    case 2:
                        returnValue = _a.sent();
                        _a.label = 3;
                    case 3:
...
var ComparisonNode = /** @class */ (function (_super) {
    ...
    ComparisonNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var left, right;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.left.evaluate(scope, dom)];
                    case 1:
                        left = _a.sent();
                        return [4 /*yield*/, this.right.evaluate(scope, dom)];
                    case 2:
                        right = _a.sent();
                        switch (this.type) {
...
var ConditionalNode = /** @class */ (function (_super) {
    ...
    ConditionalNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var condition;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.condition.evaluate(scope, dom)];
                    case 1:
                        condition = _a.sent();
                        if (!condition) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.block.evaluate(scope, dom)];
...
var IfStatementNode = /** @class */ (function (_super) {
    ...
    IfStatementNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        condition = _a[_i];
                        return [4 /*yield*/, condition.condition.evaluate(scope, dom)];
                    case 2:
                        uno = _b.sent();
                        if (!uno) return [3 /*break*/, 4];
                        return [4 /*yield*/, condition.block.evaluate(scope, dom)];
...
var ForStatementNode = /** @class */ (function (_super) {
    ...
    ForStatementNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var variable, list, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.variable.evaluate(scope, dom)];
                    case 1:
                        variable = _a.sent();
                        return [4 /*yield*/, this.list.evaluate(scope, dom)];
                    case 2:
                        list = _a.sent();
                        i = 0;
                        _a.label = 3;
...
var NotNode = /** @class */ (function (_super) {
    ...
    NotNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var flipping;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.toFlip.evaluate(scope, dom)];
                    case 1:
                        flipping = _a.sent();
...
var LiteralNode = /** @class */ (function (_super) {
    ...
    LiteralNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
var FunctionCallNode = /** @class */ (function (_super) {
    ...
    FunctionCallNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fnc.scope.evaluate(scope, dom)];
                    case 1:
                        functionScope = _b.sent();
                        _b.label = 2;
                    case 2: return [4 /*yield*/, this.args.evaluate(scope, dom)];
                    case 3:
                        values = _b.sent();
                        return [4 /*yield*/, this.fnc.evaluate(scope, dom)];
...
var FunctionArgumentNode = /** @class */ (function (_super) {
    ...
    FunctionArgumentNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        arg = _a[_i];
                        _c = (_b = values).push;
                        return [4 /*yield*/, arg.evaluate(scope, dom)];
                    case 2:
                        _c.apply(_b, [_d.sent()]);
                        _d.label = 3;
                    case 3:
...
var ScopeMemberNode = /** @class */ (function (_super) {
    ...
    ScopeMemberNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.scope.evaluate(scope, dom)];
                    case 1:
                        scopes = _e.sent();
                        return [3 /*break*/, 4];
                    case 2:
                    ...
                    case 5:
                        ...
                        if (parent_1 instanceof Tag_1.Tag)
                            parent_1 = parent_1.scope;
                        if (!!parent_1) return [3 /*break*/, 7];
                        _c = Error;
                        _d = "Cannot access \"";
                        return [4 /*yield*/, this.name.evaluate(scope, dom)];
                    case 6: throw _c.apply(void 0, [_d + (_e.sent()) + "\" of undefined."]);
                    case 7: return [4 /*yield*/, this.name.evaluate(scope, dom)];
                    case 8:
                        name_1 = _e.sent();
...
var RootScopeMemberNode = /** @class */ (function (_super) {
    ...
    RootScopeMemberNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var value, _a, _b;
...
var ArithmeticNode = /** @class */ (function (_super) {
    ...
    ArithmeticNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var left, right;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var ArithmeticAssignmentNode = /** @class */ (function (_super) {
    ...
    ArithmeticAssignmentNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var scopes, name, inner, values, _i, scopes_2, localScope, left, right, i;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        scopes = [];
                        return [4 /*yield*/, this.left.name.evaluate(scope, dom)];
                    case 1:
                        name = _a.sent();
                        if (!(this.left instanceof ScopeMemberNode)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.left.scope.evaluate(scope, dom)];
                    case 2:
                        inner = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.left.elementRef.evaluate(scope, dom)];
                    case 4:
                        scopes = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
                    ...
                    case 6:
                        ...
                        _a.label = 7;
                    case 7:
                        if (!(_i < scopes_2.length)) return [3 /*break*/, 11];
                        ...
                        if (localScope instanceof Tag_1.Tag) {
                            ...
                            localScope = localScope['$scope'];
                        return [4 /*yield*/, this.left.evaluate(localScope, dom)];
                    case 8:
                        left = _a.sent();
                        return [4 /*yield*/, this.right.evaluate(localScope, dom)];
                    case 9:
                        right = _a.sent();
                    ...
                    case 10:
                        _i++;
                        return [3 /*break*/, 7];
                    case 11: return [2 /*return*/, values.length > 1 ? values : values[0]];
                }
            });
        });
    };
    ...
    ArithmeticAssignmentNode.parsed = function (lastNode, token, tokens) {
        ...
        var assignmentTokens = Tree.getNextStatementTokens(tokens);
...
var IndexNode = /** @class */ (function (_super) {
    ...
    IndexNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var obj, index, _a, _b, indexTwo, _c, _d, values, i;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, this.object.evaluate(scope, dom)];
                    case 1:
                        obj = _e.sent();
                        _a = this.negativeIndex;
                        _b = [obj];
                        return [4 /*yield*/, this.index.evaluate(scope, dom)];
                    case 2:
                        index = _a.apply(this, _b.concat([_e.sent()]));
                        if (!(Number.isFinite(index) && this.indexTwo)) return [3 /*break*/, 4];
                        _c = this.negativeIndex;
                        _d = [obj];
                        return [4 /*yield*/, this.indexTwo.evaluate(scope, dom)];
                    case 3:
...
var ArrayNode = /** @class */ (function (_super) {
    ...
    ArrayNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        val = _a[_i];
                        _c = (_b = arr).push;
                        return [4 /*yield*/, val.evaluate(scope, dom)];
                    case 2:
                        _c.apply(_b, [_d.sent()]);
                        _d.label = 3;
                    case 3:
...
var ObjectNode = /** @class */ (function (_super) {
    ...
    ObjectNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        val = this.values[i];
                        _b = (_a = obj).set;
                        return [4 /*yield*/, key.evaluate(scope, dom)];
                    case 2:
                        _c = [_d.sent()];
                        return [4 /*yield*/, val.evaluate(scope, dom)];
                    case 3:
...
var ElementQueryNode = /** @class */ (function (_super) {
    ...
    ElementQueryNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dom.get(this.query, true)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ElementQueryNode.prototype.prepare = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dom.get(this.query, true)];
...
var ElementAttributeNode = /** @class */ (function (_super) {
    ...
    ElementAttributeNode.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var tags;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.elementRef.evaluate(scope, dom)];
                    case 1:
                        tags = _a.sent();
    ...
    ElementAttributeNode.prototype.prepare = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            var tags, _i, tags_1, tag;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.elementRef.prepare(scope, dom)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.elementRef.evaluate(scope, dom)];
                    case 2:
                        tags = _a.sent();
                        _i = 0, tags_1 = tags;
                        _a.label = 3;
...
var Tree = /** @class */ (function () {
    ...
    Tree.prototype.evaluate = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rootNode.evaluate(scope, dom)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Tree.prototype.prepare = function (scope, dom) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.rootNode.isPreparationRequired())
                            return [2 /*return*/];
                        return [4 /*yield*/, this.rootNode.prepare(scope, dom)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    Tree.prototype.bindToScopeChanges = function (scope, fnc) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _i = 0, _a = this.rootNode.findChildrenByTypes([RootScopeMemberNode, ScopeMemberNode], 'ScopeMemberNodes');
                        _b.label = 1;
                    case 1:
                        ...
                        return [4 /*yield*/, node.scope.evaluate(scope, null)];
                    case 2:
                        _scope = _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, node.name.evaluate(scope, null)];
                    case 4:
                        name_2 = _b.sent();
