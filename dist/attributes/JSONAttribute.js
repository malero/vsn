...
exports.JSONAttribute = void 0;
var Registry_1 = require("../Registry");
var Attribute_1 = require("../Attribute");
var Scope_1 = require("../Scope");
var JSONAttribute = /** @class */ (function (_super) {
    __extends(JSONAttribute, _super);
    ...
    JSONAttribute.prototype.extract = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        scopeKey = this.getAttributeBinding();
                        try {
    ...
    JSONAttribute.canDefer = false;
    JSONAttribute = __decorate([
        Registry_1.Registry.attribute('vsn-json')
    ], JSONAttribute);
    return JSONAttribute;
}(Attribute_1.Attribute));
exports.JSONAttribute = JSONAttribute;
//# sourceMappingURL=JSONAttribute.js.map