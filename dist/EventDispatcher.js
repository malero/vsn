...
var EventDispatcher = /** @class */ (function () {
    ...
    EventDispatcher.prototype.deconstruct = function () {
        ...
        for (var k in this._listeners) {
            try {
                for (var _c = (e_1 = void 0, __values(this._listeners[k])), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var cb = _d.value;
                    cb.deconstruct();
                }
            }
    ...
    EventDispatcher.prototype.noneWithContext = function (context) {
        ...
        for (var k in this._listeners) {
            var toRemove = [];
            try {
                for (var _g = (e_9 = void 0, __values(this._listeners[k])), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var cb = _h.value;
                    if (context == cb.context) {
                        toRemove.push(cb);
                    }
            ...
            try {
                for (var toRemove_2 = (e_10 = void 0, __values(toRemove)), toRemove_2_1 = toRemove_2.next(); !toRemove_2_1.done; toRemove_2_1 = toRemove_2.next()) {
