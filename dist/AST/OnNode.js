...
var OnNode = /** @class */ (function (_super) {
    __extends(OnNode, _super);
    function OnNode() {
    ...
    OnNode.parse = function (lastNode, token, tokens) {
        return _super.parse.call(this, lastNode, token, tokens, OnNode);
    };
    return OnNode;
