...
var DOM = /** @class */ (function (_super) {
    ...
    DOM.prototype.get = function (selector, create) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getTagsForElement(Array.from(nodes), create)];
    ...
    DOM.prototype.querySelectorAll = function (q) {
    ...
    DOM.prototype.buildFrom = function (ele, isRoot) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var allElements, _i, _a, tag, newTags, toBuild, _b, _c, element, _d, toBuild_1, element, tag, _e, _f, newTags_1, tag, _g, newTags_2, tag, _h, newTags_3, tag, parentElement, foundParent, _j, _k, newTags_4, tag, _l, newTags_5, tag, _m, newTags_6, tag, _o, newTags_7, tag, _p, newTags_8, tag;
    ...
    DOM.prototype.getTagsForElement = function (elements, create) {
        if (create === void 0) { create = false; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.buildFrom(element.parentElement)];
                    case 1:
                        _b.sent();
