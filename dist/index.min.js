...
`);n.trim()&&t.registerBehaviors(n),t.mount(s);let a=typeof performance<"u"&&performance.now?performance.now():Date.now(),o=Math.round(a-e);console.log(`Took ${o}ms to start up VSN.js. https://www.vsnjs.com/ v${Le}`)}};return document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>setTimeout(r,0),{once:!0}):setTimeout(r,0),t}typeof document<"u"&&document.querySelector("script[auto-mount]")&&Re();export{de as ArrayExpression,_ as ArrayPattern,be as AssertError,ae as AssertNode,F as AssignmentNode,Y as AwaitExpression,m as BaseNode,H as BehaviorNode,B as BinaryExpression,b as BlockNode,ie as BreakNode,A as CallExpression,ne as ContinueNode,U as DeclarationNode,k as DirectiveExpression,N as ElementDirectiveExpression,J as ElementPropertyExpression,K as ElementRefExpression,ee as Engine,pe as ForEachNode,le as ForNode,$ as FunctionDeclarationNode,T as FunctionExpression,y as IdentifierExpression,oe as IfNode,S as IndexExpression,q as Lexer,w as LiteralExpression,x as MemberExpression,me as ObjectExpression,V as ObjectPattern,M as OnBlockNode,L as Parser,te as ProgramNode,ge as QueryExpression,j as RestElement,O as ReturnNode,se as SelectorNode,G as SpreadElement,ue as TaggedTemplateExpression,Q as TemplateExpression,fe as TernaryExpression,Ne as TokenType,he as TryNode,Z as UnaryExpression,re as UseNode,Le as VERSION,ce as WhileNode,Re as autoMount,Ie as parseCFS};
